      ...
      <div className="dashboard">
        <div className="containt">
          ...
          <form className="addroute">
            ...
            { loading ?  <Skeleton cards={4} />: loading === false && routes && routes.data ? routes.data.routes.routes.rows.map(route =>
                ...
                <Grid item container minHeight={20} sx={{ width: "95%", margin: { xs: "auto", sm: "auto" }, display: "flex" }}>
                  <Grid item sx={{ margin: { xs: 1, sm: 1 } }} xs={12} md={6.75} border={"1px solid #364878"}>
                    ...
                    <Box my={2} sx={{ display: 'flex' }}>
                      ...
                      <Box my={2} sx={{ display: 'flex' }}>
                        <Typography sx={{ width: 50 , fontWeight:"bold", display:"flex", marginLeft:"10px",Right:"10px", justifyContent:"center", color: "green"}}>
                          {' '}
                         ...............{' '}
                        </Typography>
              ...
              </Grid>) : !routes && <div> No route found</div>}
          </form>
        </div>
      </div>
    </DashboardLayout>
