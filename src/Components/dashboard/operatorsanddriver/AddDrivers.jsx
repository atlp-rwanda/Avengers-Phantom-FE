        ...
        <div>
          <Grid container columns={15} className="gridcontainer">
            <Grid item xs={5}>
              ...
              <InputLabel id="demo-multiple-name-label">Email</InputLabel>
              <TextField id="outlined-basic" variant="outlined" />
              <InputLabel id="demo-multiple-name-label">Carplate</InputLabel>
              <TextField id="outlined-basic" variant="outlined" />
            </Grid>
            <Grid item xs={5}>
              <InputLabel id="demo-multiple-name-label">ID number</InputLabel>
              <TextField id="outlined-basic" variant="outlined" />
              <InputLabel id="demo-multiple-name-label">Sector</InputLabel>
              <TextField id="outlined-basic" variant="outlined" />
              <InputLabel id="demo-multiple-name-label">Permit Id</InputLabel>
              <TextField id="outlined-basic" variant="outlined" />
              <InputLabel id="demo-multiple-name-label">Capacity</InputLabel>
              <TextField id="outlined-basic" variant="outlined" />
            </Grid>
            <Grid item xs={5}>
              <InputLabel id="demo-multiple-name-label">Gender</InputLabel>
              ...
              <InputLabel id="demo-multiple-name-label">Cell</InputLabel>
              <TextField id="outlined-basic" variant="outlined" />
              <InputLabel id="demo-multiple-name-label">Tell number</InputLabel>
              <TextField id="outlined-basic" variant="outlined" />
              <InputLabel id="demo-multiple-name-label" className="inputlabel">
                Vehicle
              </InputLabel>
              <TextField id="outlined-basic" variant="outlined" />
              <Button text="Add" bcolor="#012241" />
