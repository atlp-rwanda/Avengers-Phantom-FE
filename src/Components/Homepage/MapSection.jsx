        ...
        <Box sx={{ display: {lg:'flex',xs:'block'}}}>
            ...
            >
              <IconButton
                ...
                sx={{ marginBottom: 2, width: 50, marginLeft: 'auto',display:{lg:'block',xs:'block'}, }}
              >
                <MenuIcon />
              </IconButton>
              <TextField
                placeholder='Browse Location'
                sx={{ marginBottom: 5, background: 'white', outline: 'none', border: 'none', borderRadius: '10px' }}
                type='search' 
                size='xsall'
                />
              ...
              <List>
                {places.map((text) => (
                  <ListItem button key={text}>
                    <ListItemText primary={text} sx={{ textAlign: 'left', padding: 1, margin: 'auto' }} />
                  </ListItem>
                ))}
              </List>
            </Box>
            ...
            >
              <Box 
                ...
                alt="map"
                />
              <Box sx={{ flexGrow: 1,color :'secondary', display: { xs: 'flex', md: 'none' },position:'absolute',top:0 }}>
                <IconButton
                  size="large"
                  aria-label="account of current user"
                  aria-controls="menu-appbar"
              ...
              <Card
                ...
                <Box sx={{ display: {lg:'flex',xs:'block'},p:1 }}>
                  <Typography sx={{ fontSize: {lg:18,xs:12}, width: '200px', textAlign: 'left' }}>
                    Point A
                  </Typography>
                  <TextField
                ...
                <Box sx={{ width: {lg:100,xs:50}, marginLeft: {lg:'auto',xs:0} }}>
                  <Button
                    sx={{
                      background: '#012241', color: 'white', borderRadius: '5px', '&:hover': {
                        background: 'white',
                        color: '#012241',
                        border: '1px solid #012241'
                      }
                    }}>
                    <Typography sx={{ fontWeight: 700,fontSize:{lg:15,xs:12} }}>
                      Go
                    </Typography>
                  </Button>
                </Box>
