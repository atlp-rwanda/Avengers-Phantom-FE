...
const ResetPassword = () => {
    ...
    return (
        <>
        <Box style={{ overflow: "hidden" }} bgcolor="rgba(1, 34, 65, 1)"  height="800px">
           <Navbar />
         ...
         <Grid container justify="center" alignItems="center">
             ...
             >
               ...
               <Grid >
                ...
                <TextField style={{margin: 20, width: '95%'}} label= 'Create New Password' name="email" Placeholder="Enter new password" type='password' fullWidth   />
                <Typography ml={2}  >Create new password</Typography>
                <TextField style={{margin: 20, width: '95%'}}  label= 'Verify New Password' name="password" Placeholder="Enter new password" type='password' fullWidth   />
               </Grid> 
                   <ul>
